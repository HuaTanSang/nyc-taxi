...
from green_taxi_pipeline.task.ingest_green_taxi import (
    stream_green_taxi_to_minio,
)


@dag(
    dag_id="green_taxi_pipeline",
    description="Stream green Taxi data to MinIO",
    schedule=None,
    ...
    tags=["nyc-taxi", "green", "minio", "raw"],
)
def green_taxi_pipeline() -> None:
    startup_task = startup_dag(taxi_type="green")

    ingestion_task = stream_green_taxi_to_minio()
